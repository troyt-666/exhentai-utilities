...
export class ArchiveAnalyzer {
    ...
    async extractGalleryInfo(archivePath) {
    ...
    extractMagazineFromFilename(filename) {
        const cleanName = filename.replace(/\.zip$/i, '');
...
//# sourceMappingURL=ArchiveAnalyzer.js.map